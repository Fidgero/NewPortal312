	...
	public function registerUser(){
		...
		if(isset($_POST['save'])){
			...
			if(mb_strlen($errorString)==0){
				...
				$sql="INSERT INTO `user` (`id`, `username`, `email`, `password`, `status`, `registration_date`, `pass`) VALUES (NULL, '$name', '$email', '$passwordHash', 'user', '$date', '$password')";
				$db = new Database();
...
?>		<!-- Закончил и проверяю Mvc4, ошибки с регистрацией -->